/*************************************************************************
	...
	> Created Time: Mon 08 May 2017 09:12:48 PM CST
 ************************************************************************/
...
public:
	Server()
		: sock_fd(-1), domain(AF_INET), type(SOCK_RAW), protocol(0)
	{ buffer_size = 1024; }
	Server(int d, int t, int p)
...
private:
	...
	vector<int> connect_info;

};

void Server::set_parameter()
{
}
